...
class SttNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter("phrase_time_limit", 15.0)
    ...
    def _extract_leading_quantity(self, remaining: str):
        quantity_words = [
            ("하나", 1),
            ("세계", 3),
            ("한", 1),
    ...
    def _extract_product_and_quantity(self, text: str):
        ...
        while remaining:
            ...
            quantity, remaining = self._extract_leading_quantity(
                remaining
            )
